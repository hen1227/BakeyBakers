...
function mousePressed() {
  ...
  {
    if(Text1_1 == " "){if(TurnX){Text1_1 = "X";}else{Text1_1 = "O";}TurnX = !TurnX;}
    
  }else if(dist(mouseX, mouseY, width/6 *3, height/6)<40)
  {
    if(Text2_1 == " "){if(TurnX){Text2_1 = "X";}else{Text2_1 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6 *5, height/6)<40)
  {
    if(Text3_1 == " "){if(TurnX){Text3_1 = "X";}else{Text3_1 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6, height/6 *3)<40)
  {
    if(Text1_2 == " "){if(TurnX){Text1_2 = "X";}else{Text1_2 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6 *3, height/6 *3)<40)
  {
    if(Text2_2 == " "){if(TurnX){Text2_2 = "X";}else{Text2_2 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6 *5, height/6 *3)<40)
  {
    if(Text3_2 == " "){if(TurnX){Text3_2 = "X";}else{Text3_2 = "O";}TurnX = !TurnX;}
  }
  else if(dist(mouseX, mouseY, width/6, height/6 *5)<40)
  {
    if(Text1_3 == " "){if(TurnX){Text1_3 = "X";}else{Text1_3 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6 *3, height/6 *5)<40)
  {
    if(Text2_3 == " "){if(TurnX){Text2_3 = "X";}else{Text2_3 = "O";}TurnX = !TurnX;}
  }else if(dist(mouseX, mouseY, width/6 *5, height/6 *5)<40)
  {
    if(Text3_3 == " "){if(TurnX){Text3_3 = "X";}else{Text3_3 = "O";}TurnX = !TurnX;}
  }
}
